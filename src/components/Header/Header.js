...
export default function Header(){
    return(
        <header className='d-flex-row pos-absolute b-surface-1 p-16 w-full pl-40 pr-40 jc-space-between ai-center'>
            <div className='d-flex-row ai-center jc-space-around w-20pourcent'>
                <img className='h-40 cursor-pointer' src={logoCarre} alt="Token" />
                <div className={styles.headerCarre}></div>
                <p className='fs-normal-plus fw-500 ff-primary-font c-on-surface'>3</p>
            </div>
            <div className='d-flex-row ai-center jc-space-around w-20pourcent'>
